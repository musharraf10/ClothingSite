...
export function ProductReviews({ productId, reviews = [], ratingsAverage, ratingsCount, canReview }) {
  ...
  return (
    <section className="mt-8 rounded-2xl p-6 space-y-6">
      ...
      <div className="grid md:grid-cols-[220px,1fr] gap-6">
        ...
        <div ref={carouselRef} className="overflow-x-auto pb-2 pr-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <div className="flex gap-4 snap-x snap-mandatory">
            {(showAll ? sorted : sorted.slice(0, 3)).map((r) => (
              <article key={r._id} className="min-w-[84vw] max-w-[84vw] sm:min-w-[320px] sm:max-w-[320px] snap-start rounded-2xl border border-[#2a2a2a] bg-gradient-to-b from-[#181818] to-[#121212] p-5 space-y-3 shrink-0">
